...
var paths = {
    ...
    distmedia: 'app/dist/assets/media',
...
gulp.task('media:dist', gulp.series('media', function () {
    return gulp.src(paths.tmpmedia + '/**/*')
