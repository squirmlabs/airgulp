# 1 About
This repository is the source code for the Basstap Records label management tool 'Air'

# 2 Screenshots
UI-wise this application looks like

We are temporarily using real data by leveraging the [Youtube Data API v3](https://developers.google.com/youtube/v3/docs/).
...
## 3.1. Temporarily usage of Youtube Data API key
...
* watching content
* displaying comments and content details
